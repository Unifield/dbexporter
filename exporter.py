...
if __name__ == '__main__':
    ...
    command = """psql  dbexporter -w -d ufdb -c \"\COPY (SELECT * from ufdb.t_journal_item WHERE oc = 'OCP') TO '/home/dbexporter/dbexporter/output/t_journal_item_OCP.csv' DELIMITER ',' CSV HEADER QUOTE '\\"' FORCE QUOTE *;" """
